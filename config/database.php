...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'mysql_record' => [
            'driver' => 'mysql',
            'host' => env('DB_RECORD_HOST', 'localhost'),
            'port' => env('DB_RECORD_PORT', '3306'),
            'database' => env('DB_RECORD_DATABASE', 'forge'),
            'username' => env('DB_RECORD_USERNAME', 'forge'),
            'password' => env('DB_RECORD_PASSWORD', ''),
            'charset' => 'utf8',
            'collation' => 'utf8_unicode_ci',
            'prefix' => '',
            'strict' => false,
